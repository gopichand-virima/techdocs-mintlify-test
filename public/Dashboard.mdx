...
By offering **real-time visibility** and **interactive data visualization**, dashboards help IT teams track performance, detect issues quickly, and collaborate effectively. Whether monitoring assets, compliance, or scan results, dashboards serve as a **single pane of glass** for operational oversight.

# Discovery Dashboard

## Accessing the Dashboard

From the navigation menu, go to **ITSM \> Configuration Management \> CMDB Dashboard**.

<img src="C:\Docs\mdx_format\media\Dashboard/media/image1-1.png" style="width:4.875in;height:2.16667in" />
...
<img src="C:\Docs\mdx_format\media\Dashboard/media/image2-1.png" style="width:4.875in;height:2.45in" />
...
<img src="C:\Docs\mdx_format\media\Dashboard/media/image3-1.gif" style="width:4.875in;height:1.8in" />

3.  In the **Search For** dropdown, select the type of content you want to add (e.g., *Ad hoc Reports*).
...
<img src="C:\Docs\mdx_format\media\Dashboard/media/image4-1.png" style="width:4.875in;height:1.19167in" />

3.  Click the **Blueprint dropdown list**.

    - A list of available CI blueprints will appear (e.g., **AHV Host, AIX Server, AV Device, AWS AMI, AWS AppRunner**, etc.).
...
<img src="C:\Docs\mdx_format\media\Dashboard/media/image5-1.png" style="width:4.875in;height:1.43333in" />
...
<img src="C:\Docs\mdx_format\media\Dashboard/media/image6-1.gif" style="width:4.875in;height:0.78333in" /><img src="C:\Docs\mdx_format\media\Dashboard/media/image7-1.gif" style="width:4.875in;height:2.18333in" />
...
<img src="C:\Docs\mdx_format\media\Dashboard/media/image8-1.gif" style="width:4.875in;height:0.825in" />
