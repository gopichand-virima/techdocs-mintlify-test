...
<img src="C:\Docs\mdx_format\media\Ignore_Process/media/image1-1.png" style="width:4.875in;height:1.5in" />
...
<img src="C:\Docs\mdx_format\media\Ignore_Process/media/image2-1.png" style="width:4.875in;height:2.50833in" />

- **Software Instance** – A software instance is created for svchost.exe.

<img src="C:\Docs\mdx_format\media\Ignore_Process/media/image3-1.png" style="width:4.875in;height:2.2in" />
...
<img src="C:\Docs\mdx_format\media\Ignore_Process/media/image4-1.png" style="width:4.875in;height:1.95in" />

However, the following are still discovered:

- IP connections associated with the process

<img src="C:\Docs\mdx_format\media\Ignore_Process/media/image5-1.png" style="width:4.875in;height:2.675in" />

- Listening processes

<img src="C:\Docs\mdx_format\media\Ignore_Process/media/image6-1.png" style="width:4.875in;height:2.88333in" />

- Relationships

<img src="C:\Docs\mdx_format\media\Ignore_Process/media/image7-1.png" style="width:4.875in;height:2.45833in" />
...
<img src="C:\Docs\mdx_format\media\Ignore_Process/media/image8-1.png" style="width:4.875in;height:2.24167in" />

- **Relationships** – No new relationships created.

<img src="C:\Docs\mdx_format\media\Ignore_Process/media/image9-1.png" style="width:4.875in;height:1.925in" />

- **Processes** – Still appear in the system.

<img src="C:\Docs\mdx_format\media\Ignore_Process/media/image10-1.png" style="width:4.875in;height:2.4in" />
